...
namespace TestApp
{
    [Activity(Label = "@string/app_name", MainLauncher = true, Icon = "@mipmap/ic_launcher", Theme = "@style/Theme.AppCompat.NoActionBar", 
        ...
        public class MainActivity : AppCompatActivity, GLSurfaceView.IRenderer, Android.Views.View.IOnTouchListener
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            var cloudSession = new Microsoft.Azure.SpatialAnchors.CloudSpatialAnchorSession();
            cloudSession.Session = mSession;
        }
